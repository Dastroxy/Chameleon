...
export default function Auth({ onSignIn, playerName, setPlayerName }: Props) {
  ...
  return (
    <div className="min-h-screen checker-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        {/* Logo card */}
        <div className="checker-hero rounded-2xl p-6 flex flex-col items-center mb-4 shadow-lg">
          ...
          <p className="text-teal-100 text-sm mt-1 font-medium">The social deduction word game</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
          ...
          <input
            ...
            maxLength={16}
            className="w-full bg-gray-50 border-2 border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary transition-colors font-medium mb-4"
          />
          <button
